      ...
      case "text":
        ...
        Map<String, dynamic> messages = {
          "sentby": seekerProfileController.viewSeekerData.value.seekerInfo!.id
              .toString(),
          "sendertype": "seeker",
          "profileimage": seekerProfileController
              .viewSeekerData.value.seekerInfo!.profileImg
              .toString(),
          'isRead': false,
          "message": textmsg,
          "type": "text",
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.more_horiz,
                color: Colors.black), // Change the icon as needed
            onPressed: () {
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (BuildContext context,
                    ...
                    if (kDebugMode) {
                      print(
                          "GRP${RecruiterId}${seekerProfileController.viewSeekerData.value.seekerInfo!.id.toString()}=======roomid");
                    }
                                            ...
                                            Align(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  // const SizedBox(width: 10,),   Text( snapshot.data!.docs[index]['isRead']==false?"Sent":"Seen",style: const TextStyle(color: Colors.white),)
                                                ],
                                              ),
                                            ),
                                        ],
...
// }
  ...
  Future<void> MessengeRead() async {
    final querySnapshot = await _firestore
        .collection('RoomID')
        .doc(
            "GRP${RecruiterId}${seekerProfileController.viewSeekerData.value.seekerInfo!.id.toString()}")
        .collection("massages")
        .get();
