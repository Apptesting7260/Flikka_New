...
class RequestTimeoutWidget extends StatefulWidget {
  ...
  const RequestTimeoutWidget({Key? key , required this.onPress}) : super(key: key);

  @override
  State<RequestTimeoutWidget> createState() => _RequestTimeoutWidget();
}

class _RequestTimeoutWidget extends State<RequestTimeoutWidget> {
  @override
        ...
        children: [
          ...
          Column( mainAxisSize: MainAxisSize.min,
            ...
            children: [
              ...
              Flexible(child: Center(child: Lottie.asset('assets/images/request_Timeout.json' ,width: Get.width * .5))),
