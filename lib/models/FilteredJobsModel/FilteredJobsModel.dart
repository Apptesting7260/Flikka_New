...
FilteredJobsListingModel filteredJobsListingFromJson(String str) => FilteredJobsListingModel.fromJson(json.decode(str));

String filteredJobsListingToJson(FilteredJobsListingModel data) => json.encode(data.toJson());

class FilteredJobsListingModel {
  bool? status;
  List<SeekerJobsData>? jobs;
  // String? message;

  FilteredJobsListingModel({
    this.status,
    this.jobs,
    // this.message,
  });

  factory FilteredJobsListingModel.fromJson(Map<String, dynamic> json) => FilteredJobsListingModel(
    status: json["status"],
