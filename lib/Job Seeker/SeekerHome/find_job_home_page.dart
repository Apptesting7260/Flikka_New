  ...
  void showReferralSubmissionDialog(BuildContext context,int index) {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
       ...
       var result = await applyJobController.applyJob(getJobsListingController.getJobsListing.value.jobs?[index].id.toString(),referralCode: controller.text) ;
       if(result){
       ...
       var result = await applyJobController.applyJob(jobFilterController.jobsData.value.jobs?[index].id.toString() , referralCode: controller.text) ;
       if(result){
                              ...
                              child: SizedBox(
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () async {
                                    CommonFunctions.showLoadingDialog(context, "Applying") ;
                                    if(jobFilterController.reset.value){
                                      var result = await applyJobController.applyJob(getJobsListingController.getJobsListing.value.jobs?[index].id.toString()) ;
                                      if(result){
                                        getJobsListingController.getJobsListing.value.jobs?[index].postApplied = true ;
                                        Get.back() ;
                                      }else{
                                      ...
                                      var result = await applyJobController.applyJob(jobFilterController.jobsData.value.jobs?[index].id.toString() ,) ;
                                      if(result){
                                        jobFilterController.jobsData.value.jobs?[index].postApplied = true ;
                                        Get.back() ;
                                      }else{
