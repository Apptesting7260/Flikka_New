...
class FindJobHomeScreenState extends State<FindJobHomeScreen> {
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    getJobsListingController
                                                                    ...
                                                                    .description ==
                                                                null ||
                                                            CommonFunctions.parseHTML(getJobsListingController
                                                                        .getJobsListing
                                                                        .value
                                                                        .jobs?[
                                                                            index]
                                                    ...
                                                    Row(
                                                      children: [
                                                        Image.asset(
                                                          "assets/images/icon_requirment.png",
                                                          height:
                                                              Get.height * .03,
                                                        ),
                                                        SizedBox(
                                                    ...
                                                    InkWell(
                                                        ...
                                                        child: SizedBox(
                                                            ...
                                                            child:
                                                              ...
                                                              jobPageView: true,
                                                              lat: double.tryParse(
                                                                  "${getJobsListingController.getJobsListing.value.jobs?[index].lat}"),
                                                              long: double.tryParse(
                                                                  "${getJobsListingController.getJobsListing.value.jobs?[index].long}"),
                                                            ))),
                                                    SizedBox(
                                                      height:
                                                          Get.height * 0.035,
  ...
  Future<bool?> showReferralSubmissionDialog(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Obx(
                        () => applyJobController
                                .errorMessageApplyReferral.value.isEmpty
                            ? const SizedBox()
                            : Text(
                                applyJobController
                                    .errorMessageApplyReferral.value,
                                style: const TextStyle(
                                ...
                                child: MyButton(
                                  onTap1: () async {
                                    ...
                                    if (controller.text.isNotEmpty) {
                                      ...
                                      applyJobController
                                          .errorMessageApplyReferral
                                          .value = "Please enter referral code";
                                    }
                                  },
                                  title: 'SUBMIT',
  ...
  void onSwipeLeft() {
    setState(() {
      if (_currentPage <
          getJobsListingController.getJobsListing.value.jobs!.length - 1) {
        _currentPage++;
      } else {
        _currentPage = 0;
      }
  ...
  Future<void> onSwipeRight() async {
    CommonFunctions.confirmationDialog(context, message: "Do you want to apply",
        onTap: () async {
      Get.back();
