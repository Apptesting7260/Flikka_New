...
class _FindJobHomeScreenState extends State<FindJobHomeScreen> {
  ...
  GetJobsListingController getJobsListingController =
      Get.put(GetJobsListingController());
  ...
  SeekerJobFilterController jobFilterController =
      Get.put(SeekerJobFilterController());
  SeekerUnSavePostController unSavePostController =
      Get.put(SeekerUnSavePostController());
                            ...
                            children: [
                              ...
                              Flexible(
                                child: last
                                    ...
                                    : getJobsListingController.getJobsListing
                                                    .value.jobs?.length ==
                                                0 ||
                                                                  ...
                                                                  GestureDetector(
                                                                      onTap:
                                                                        ...
                                                                        CommonFunctions.confirmationDialog(
                                                                            context,
                                                                            message: getJobsListingController.getJobsListing.value.jobs?[index].postSaved
                                                                          ...
                                                                          if (data?.postSaved ==
                                                                            ...
                                                                            CommonFunctions.showLoadingDialog(context,
                                                                                "Saving");
                                                                            var result =
                                                                                await seekerSaveJobController.saveJobApi(data?.id, 1);
                                                                            if (result ==
                                                                                true) {
                                                                              if (kDebugMode) {
                                                                                print("inside result");
                                                                      ...
                                                                      child: getJobsListingController.getJobsListing.value.jobs?[index].postSaved ==
                                                                              false
                                                                          ? Image
                                                                              .asset(
                                                                      ...
                                                                      ? InkWell(
                                                                          child:
                                                                            ...
                                                                            width:
                                                                                34,
                                                                            decoration:
                                                                                const BoxDecoration(shape: BoxShape.circle, color: AppColors.blueThemeColor),
                                                                            child:
                                                                                Image.asset(
                                                                          ...
                                                                          onTap:
                                                                            ...
                                                                            Recruiterimg =
                                                                                data?.recruiterDetails?.profileImg;
                                                                  ...
                                                                  GestureDetector(
                                                                      onTap:
                                                                        ...
                                                                        showPound(
                                                                            context,
                                                                            data?.recruiterDetails?.companyName,
                                                                            "${data?.jobsDetail?.minSalaryExpectation / 20}".split(".")[0]);
                                                                      },
                                                                      child: Image
                                                                          .asset(
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      data?.description == null ||
                                                                              CommonFunctions.parseHTML(data?.description).toString().trim().length == 0
                                                                          ? Text(
                                                                              "No job description",
                                                                              style: Theme.of(context).textTheme.labelLarge!.copyWith(color: AppColors.ratingcommenttextcolor, fontWeight: FontWeight.w400),
                                                                              maxLines: 3,
                                                                            )
                                                                          : Text(
                                                                              CommonFunctions.parseHtmlAndAddNewline(data?.description ?? "No job description"),
                                                                              overflow: TextOverflow.ellipsis,
                                                                      ...
                                                                      data?.requirements == null ||
                                                                              CommonFunctions.parseHTML(data?.requirements).toString().trim().length == 0
                                                                          ? Text(
                                                                              "No requirements",
                                                                              style: Theme.of(context).textTheme.labelLarge!.copyWith(color: AppColors.ratingcommenttextcolor, fontWeight: FontWeight.w400),
                                                                            )
                                                                          : Text(
                                                                              CommonFunctions.parseHtmlAndAddNewline(data?.requirements ?? "No requirements"),
                                                                              overflow: TextOverflow.ellipsis,
                                                                              style: Theme.of(context).textTheme.labelLarge!.copyWith(color: AppColors.ratingcommenttextcolor, fontWeight: FontWeight.w400, overflow: TextOverflow.ellipsis),
                                                                            ),
                                                                      Flexible(
                                                                        child:
                                                                            SizedBox(
  ...
  void showPound(
      BuildContext context, String companyName, dynamic minimumSalary) {
    showDialog(
      context: context,
      barrierDismissible: false,
      builder: (BuildContext context) {
  ...
  void showReferralSubmissionDialog(BuildContext context, int index) {
                      ...
                      Center(
                        child: Row(
                          ...
                          children: [
                                      ...
                                      if (controller.text.isNotEmpty) {
                                        ...
                                        if (jobFilterController.reset.value) {
                                          ...
                                          var result =
                                              await applyJobController.applyJob(
                                                  context,
                                                  jobFilterController.jobsData
                                                      .value.jobs?[index].id
                                                      .toString(),
                                                  referralCode: controller.text);
                                          if (result) {
                                            jobFilterController.jobsData.value
                                                .jobs?[index].postApplied = true;
                                            Get.back();
                                          } else {
                                            Get.back();
                                          }
                            ...
                            const SizedBox(
                                width: 20), // Adding spacing between buttons
                            Expanded(
                              child: SizedBox(
                                height: Get.height * 0.06,
