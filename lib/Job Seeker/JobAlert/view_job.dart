...
class JobViewJobAlertState extends State<JobViewJobAlert> {
  ...
  SeekerJobAlertWiseJobListingController seekerJobAlertWiseJobListingControllerInstanse = Get
      .put(SeekerJobAlertWiseJobListingController());

  TabBarController tabBarController = Get.put(TabBarController());
  GetJobsListingController getJobsListingController = Get.put(
      GetJobsListingController());
  ViewSeekerProfileController seekerProfileController = Get.put(
      ViewSeekerProfileController());
  SeekerSaveJobController seekerSaveJobController = Get.put(
      SeekerSaveJobController());
  ApplyJobController applyJobController = Get.put(ApplyJobController());
  SeekerUnSavePostController unSavePostController = Get.put(
      SeekerUnSavePostController());
                          ...
                          child: Column(
                            children: [
                              GestureDetector(
                                  onTap:
                                    ...
                                    CommonFunctions.confirmationDialog(context,
                                        message: getJobsListingController
                                            .getJobsListing.value.jobs?[index]
                                            .postSaved
                                        ...
                                        onTap: () async {
                                          ...
                                          if (getJobsListingController
                                            ...
                                            CommonFunctions.showLoadingDialog(
                                                context, "removing...");
                                            var result = await unSavePostController
                                                .unSavePost(
                                                getJobsListingController
                                            ...
                                            CommonFunctions.showLoadingDialog(
                                                context, "Saving");
                                            var result = await seekerSaveJobController
                                                .saveJobApi(
                                                getJobsListingController
                                                    .getJobsListing.value
                                                    .jobs?[index].id, 1);
                                  ...
                                  child: getJobsListingController.getJobsListing
                                      .value.jobs?[index].postSaved == false
                                      ? Image.asset(
