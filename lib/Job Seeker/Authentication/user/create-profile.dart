...
class _CreateProfileState extends State<CreateProfile> {
                                    ...
                                    onTap1: () {
                                      if (educationLevelController.text
                                        ...
                                        educationList.add({
                                          ...
                                          institutionNameController.text,
                                          "education_start_date":
                                          "${startDateEducation?.year.toString()
                                              .padLeft(
                                              4, '0')}-${startDateEducation
                                              ?.month.toString().padLeft(
                                              2, '0')}-${startDateEducation?.day
                                          ...
                                          "education_end_date": educationPresent ==
                                              ...
                                              endDateEducation
                                                  ...
                                                  .isEmpty
                                              ? "present"
                                              : "${endDateEducation?.year
                                              .toString().padLeft(
                                              4, '0')}-${endDateEducation?.month
                                              .toString().padLeft(
                                              2, '0')}-${endDateEducation?.day
                                              .toString().padLeft(2, '0')}",
                                        });
                                      }
                                      ...
                                      if (jobTitleController.text.isNotEmpty &&
                                        ...
                                        workExperienceList.add({
                                          "work_exp_job": jobTitleController
                                              .text,
                                          "company_name": companyNameController
                                              .text,
                                          "job_start_date":
                                          "${startDateExperience?.year
                                              .toString().padLeft(
                                              4, '0')}-${startDateExperience
                                              ?.month.toString().padLeft(
                                              2, '0')}-${startDateExperience
                                              ?.day.toString().padLeft(
                                              2, '0')}",
                                          "job_end_date": experiencePresent ==
                                              true ||
                                              endDateExperience == null ||
                                              endDateExperience
                                                  .toString()
                                                  .isEmpty
                                              ? "present"
                                              : "${endDateExperience?.year
                                              .toString().padLeft(
                                              4, '0')}-${endDateExperience
                                              ?.month.toString().padLeft(
                                              2, '0')}-${endDateExperience?.day
                                              .toString().padLeft(2, '0')}",
                                        });
                                      }
  ...
  addMoreFieldExperience({required TextEditingController jobController,
  ...
  addMoreFieldAppreciation({required TextEditingController awardController,
  ...
  Future<void> _selectDate(BuildContext context,
    ...
    if (picked != null) {
      setState(() {
        ...
        controller.text =
        "${picked.year.toString().padLeft(4, '0')}-${picked.month.toString()
            .padLeft(2, '0')}-${picked.day.toString().padLeft(2, '0')}";
      });
    }
  }
  ...
  Future<void> compressVideo(String inputPath) async {
    ...
    if (info?.path != null && info?.path?.length != 0) {
      // Initialize the trimmer with the compressed video
