                              ...
                              children: [
                                DropdownButtonHideUnderline(
                                  child: DropdownButton2(
                                    isExpanded: true,
                                    hint: Text(
                                      jobPositionValue == null ? 'Select position' : jobPositionValue.toString(),
                                      ...
                                      return ListView.builder(
                                          ...
                                          itemBuilder: (context, index) {
                                            ...
                                            return Container(
                                              ...
                                              decoration: BoxDecoration(color: const Color(0xff353535),
                                                  ...
                                                  ListTile(contentPadding: EdgeInsets.zero,
                                                    ...
                                                    leading: CircleAvatar(
                                                      ...
                                                      child: CachedNetworkImage(
                                                        ...
                                                        errorWidget: (context, url, error) => const SizedBox(height: 40,child: Placeholder(),),
                                                      ),
                                                    ),
                                                    title: Text(data?.seekerData?.fullname ?? "No data",
                                                    ...
                                                    subtitle: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        SizedBox(height: Get.height * .003,),
                                                        SizedBox(height: Get.height * .003,),
                                                        Text(data?.seekerData?.location ?? "No location",
                                                          overflow: TextOverflow.ellipsis,
                                                        ...
                                                        Text(data?.status.toString().toLowerCase() ?? "",
                                                          style: Theme.of(context).textTheme.labelLarge
                                                              ...
                                                              const Color(0xff42D396) : "${data?.status}".toLowerCase()
                                                                  == "rejected" ? AppColors.red : AppColors.white
                                                          ),),
                                                      ],
                                                    ),
                                                  ),
                                                  SizedBox(height: Get.height * .010,),
                                                  MyButton(height: Get.height * .059,
                                                    width: Get.width * .75,
                                                    title: "VIEW PROFILE",
                                                    onTap1: () {
                                                      Get.to(() =>
