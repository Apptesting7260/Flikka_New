...
class SelectedCandidateHiring extends StatefulWidget {
  const SelectedCandidateHiring({super.key});

  @override
  State<SelectedCandidateHiring> createState() => _SelectedCandidateHiringState();
}

class _SelectedCandidateHiringState extends State<SelectedCandidateHiring> {
