...
import '../../controllers/TalentPoolController/RemoveFromPoolController.dart';
...
class _TalentPoolHiringState extends State<TalentPoolHiring> {
  ...
  @override
  void initState() {
    if(poolController.poolData.value.data == null || poolController.poolData.value.data?.length == 0)
                                        ...
                                        children: [
                                          ...
                                          Text( data?.seekerData?.location ?? "No location", overflow: TextOverflow.ellipsis,
                                            style: Theme.of(context).textTheme.labelLarge?.copyWith
                                              (fontWeight: FontWeight.w400, color: const Color(0xffCFCFCF)),),
                                        ],
                                      ),
                                    ),
                                    SizedBox(height: Get.height * .02,),
